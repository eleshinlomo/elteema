...
const Featured = () => {
    ...
    return (
        <div id='search' className="hidden md:block bg-gradient-to-b from-green-50 to-white mt-2 pb-4 px-8 ">
              <div className="hidden md:block mx-0 mb-5">
                            <Hero />
                        </div>
        ...
        <div className="flex justify-center mt-3">
                ...
                <button className="flex items-center rounded-full bg-gradient-to-r from-green-600 to-green-800 text-white px-2 py-2 shadow-md hover:shadow-lg transition-all hover:scale-105">
    ...
    {/* <div className="">
        <HotProductFlash />
                ...
                {searchedItemFound && searchedItemList.length > 0 ? (
                    ...
                    <div className="animate-fadeIn">
                        <DisplayStore productArray={Products.slice(0, 2)} numPerPage={2} />
                    </div>
                )}
            </div>
        </div>
