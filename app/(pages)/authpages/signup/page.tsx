...
export const metadata: Metadata = {
  title: "Sign Up Page | Efarms",
  description: "This efarms ecommerce website",
  // other metadata
};
...
const SignupPage = () => {
  return (
    <>
      <section className="relative z-10 overflow-hidden pb-16 pt-16 md:pb-20 ">
            ...
            <div className="w-full px-4">
              <div className="shadow-three mx-auto max-w-[500px] rounded bg-white px-6 py-10 dark:bg-dark sm:p-[60px]">
                ...
                <p className="text-center text-base font-medium text-body-color">
                  Already registered?{" "}
                  <Link href="/authpages/signin" className="text-green-500 hover:underline">
                    Sign in
                  </Link>
                </p>
              </div>
