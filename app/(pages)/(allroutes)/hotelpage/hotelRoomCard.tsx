...
export interface HotelArrayProps {
    hotels: HotelProps[]
}
const HotelRoomCard = ({hotels}: HotelArrayProps) => {
  return (
    <div className="">
      {hotels?.length > 0 ?
      ...
      <div className="relative h-48 overflow-hidden">
        <img 
          ...
          src={hotel.imageUrl || "https://images.unsplash.com/photo-1566073771259-6a8506099945?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80"} 
          alt={`${hotel.roomType} at ${hotel.hotelName}`}
        />
        <div className="absolute top-3 right-3 bg-white/90 px-2 py-1 rounded-full flex items-center">
          ...
          <span className="text-sm font-semibold">{hotel.rating || "4.8"}</span>
        </div>
      </div>
      ...
      <div className="flex flex-col justify-center items-center">
        <p>No hotel found in your city</p>
